 ...
 * background jobs finishing with no tab open to tell Claude about it (see
 * .notes/handoff-wake-idle-session.md). Runs invisibly: the model still just
 * writes an ordinary `run_in_background` Bash call, and this rewrite happens
